...
const file_sample_sample_proto_rawDesc = "" +
	...
	"GetAccount\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\tR\taccountId\"\x0e\n" +
	"\fAuthenticate\"\x0f\n" +
	"\rAuthenticated\"\b\n" +
	"\x06Logout\"\a\n" +
	"\x05Begin\"\x05\n" +
	"\x03EndB\x9f\x01\n" +
	"\fcom.samplepbB\vSampleProtoH\x02P\x01Z@github.com/tochemey/goakt-examples/v2/internal/samplepb;samplepb\xa2\x02\x03SXX\xaa\x02\bSamplepb\xca\x02\bSamplepb\xe2\x02\x14Samplepb\\GPBMetadata\xea\x02\bSamplepbb\x06proto3"
