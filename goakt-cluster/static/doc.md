...
3. run at the root of the cloned repository `make static-image`
4. run `docker-compose up node1 node2 node3` to start the cluster of three nodes. To stop the cluster just run
